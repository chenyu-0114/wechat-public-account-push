export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx8bd4b36a8489a6c1",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "84b8d0c5aebd09137d3b53e7db9accad",
  ...
  USERS: [
    {
      ...
      id: "o7Aqa6P7lQJxlDBDaeDImEY8F2Ck",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "k0legeZlSypMgQ4ABDN9uQnaO7QFMXmNrsn7P8vHOYU",
      // 所在省份
      province: "江苏",
      // 所在城市
      city: "南京",
  ...
  CALLBACK_TEMPLATE_ID: "gDq5qlDGf7SXCYIDJaPkvlImyTGciJV3VZDCWJTJ8PI",
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "o7Aqa6BcKsv1hir0oRfUQAJVwdxw",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
